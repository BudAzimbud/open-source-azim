      ...
      <div className="max-w-7xl mx-auto px-8 relative">
        ...
        <div className={`text-center mb-20 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Over 4+ years of building exceptional digital experiences across enterprise, fintech, and startup environments
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
                    ...
                    >
                      ...
                      <div className={`ml-12 p-6 rounded-2xl transition-all duration-500 ${
                        ...
                        <div className="flex items-center justify-between mb-2">
                          <span className={`px-3 py-1 rounded-full text-sm font-medium ${getColorClasses(index)}`}>
                            {exp.type}
                          </span>
          ...
          <div className="lg:col-span-8">
            <div className={`transform transition-all duration-700 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
              ...
              <div className={`relative bg-gradient-to-br ${getGradient(activeExperience)} rounded-3xl p-1 mb-8 shadow-2xl`}>
                <div className="bg-white rounded-3xl p-8">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-3">
                      {currentExp.responsibilities.slice(0, 4).map((responsibility, index) => (
                        <div key={index} className="flex items-start space-x-3 p-3 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
              ...
              {currentExp.companyUrl && (
                <div className="text-center mb-8">
                  <a 
                    ...
                    className="inline-flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-medium transition-all hover:scale-105"
                  >
