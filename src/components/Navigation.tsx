          ...
          <div className="flex items-center justify-between h-16">
            ...
            <button
              ...
              className={`md:hidden p-2 rounded-lg transition-colors duration-300 ${
                isScrolled ? 'text-gray-700 hover:bg-gray-100' : 'text-white hover:bg-white/20 drop-shadow-md'
              }`}
            >
          ...
          <div className="md:hidden bg-white/98 backdrop-blur-lg border-t border-gray-200/70 shadow-lg">
            <div className="px-6 py-4 space-y-4">
              ...
              <Link 
                href="/article" 
                className={`block py-3 px-2 rounded-lg transition-all duration-300 ${
                  isActive('/article') ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-700 hover:text-blue-600 hover:bg-gray-50'
                }`}
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Articles
