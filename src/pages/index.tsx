      ...
      <div className="relative min-h-screen overflow-hidden">
        ...
        {services.map((service, index) => (
          <div
            ...
            style={{
              backgroundImage: `url('${service.image.replace(
                "w=800&h=600",
                "w=1920&h=1080"
              )}')`,
            }}
          ...
          <div className="lg:max-w-7xl lg:mt-0 mt-10 w-full">
            ...
            <div className="md:grid  lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative lg:mt-10 mt-20">
                ...
                {/* Navigation Arrows */}
                <div
                  className={`flex gap-3 md:mt-6 justify-center lg:justify-start transition-all duration-500 ${
                    isAnimating
                ...
                {/* Slide Indicators */}
                <div
                  className={`flex gap-2 mt-4 justify-center lg:justify-start transition-all duration-500 ${
                    isAnimating
                      ? "opacity-0 pointer-events-none"
                      : "opacity-100"
                  }`}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Discover amazing workspace setups from gaming rigs to productivity
              stations
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="group bg-white/10 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/20 hover:border-white/40 transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <p className="text-blue-100 mb-4">
                  Complete gaming and productivity workspace with RGB lighting,
                  dual monitors, and premium peripherals.
                </p>
            ...
            <div className="group bg-white/10 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/20 hover:border-white/40 transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <p className="text-blue-100 mb-4">
                  Clean and minimal setup focused on productivity with essential
            ...
            <div className="group bg-white/10 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/20 hover:border-white/40 transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <p className="text-blue-100 mb-4">
                  Professional streaming setup with high-end camera, lighting,
                  and audio equipment.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="text-xs bg-purple-500/20 text-purple-200 px-2 py-1 rounded-full">
          ...
          <div className="text-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-white/20">
              ...
              <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
                Discover hundreds of amazing workspace setups, from gaming rigs
                to productivity stations. Get inspired and find the perfect
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                I reply to emails within 2 hours (often much faster). When I say
                a project takes 2 weeks, it gets done in 2 weeks. No corporate
                delays or endless meetings.
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                I lose sleep over bugs and poor user experiences. Your project
                gets the same attention I'd give my own business (because your
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                You work directly with me, not a junior developer or account
                manager. I know every line of code in your project and can
                explain any decision I made.
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Coffee at 6 AM or late-night emergency? I'm probably awake
                anyway. Your project won't sit in a queue waiting for "business
                hours."
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                I'll tell you when something won't work, even if it costs me
                money. Your trust is worth more than any project fee.
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                I build things to last and grow with you. No proprietary lock-in
                or vendor dependencies - you own everything I create for you.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                "I was drowning in emails and admin work. Alex built me a
                virtual assistant system that handles 80% of my routine tasks.
                Now I actually have time to focus on my clients again!"
              </p>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                "My previous developer disappeared mid-project. Alex not only
                finished what they started but found and fixed 12 critical bugs.
                My app actually works now!"
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                "Alex doesn't just build websites - he actually listens. He
                understood my vision better than I did and delivered something
                beyond my expectations. Plus, he's genuinely fun to work with!"
              </p>
              <div className="flex items-center">
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-4xl mx-auto text-center px-8">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            I'm currently accepting new projects for Q4 2025. Let's grab a
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Random thoughts on tech, business, and life. Sometimes useful,
              always honest.
            </p>
          </div>
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed mb-6">
                    Three years ago, I had a corner office and a six-figure
                    salary. Today, I work from coffee shops and make more money.
                    Here's what changed and why I'm never going back.
                  </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <article className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Spoiler: It's not all coffee shops and flexible schedules. The
                  real truth about freelancing that no one talks about.
                </p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
            ...
            <article className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Discover proven digital marketing tactics that drive real
            ...
            <article className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Best practices for implementing effective QA processes in
            ...
            <article className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Protect your mobile applications with these crucial security
            ...
            <article className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  How early-stage companies can leverage data analytics to make
            ...
            <article className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Strategies for managing and motivating remote teams in the
                  modern workplace.
                </p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 md:p-12 text-white text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-blue-100 text-lg mb-8">
                I send one email per month with lessons learned, project
                updates, and the occasional rant about bad UX design. No spam,
                no sales pitches.
              </p>
              ...
              <p className="text-blue-100 text-sm mt-4">
                Join 847 people who apparently enjoy my random thoughts.
                Unsubscribe anytime (I won't be offended).
              </p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-8 text-center">
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              If my articles helped you solve a problem, or you just want to
              support my work, consider buying me a coffee. It literally keeps
              me coding through those late-night bug hunts!
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-2 border-transparent hover:border-amber-200">
              ...
              <p className="text-gray-600 mb-6">
                A regular coffee to keep me going through the next article or
                code review.
              </p>
              <button
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-2 border-amber-300 relative">
              ...
              <p className="text-gray-600 mb-6">
                Enough coffee for a solid coding session. Perfect for when my
                content saves you hours of work!
              </p>
              <button
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-2 border-transparent hover:border-amber-200">
              ...
              <p className="text-gray-600 mb-6">
                Coffee plus a snack for those marathon debugging sessions.
                You're basically funding my productivity!
              </p>
              <button
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 italic">
              {recentSupporters.length > 0 && recentSupporters[0].testimonial
                ? `"${recentSupporters[0].testimonial}" - ${
                    recentSupporters[0].name || "Anonymous"
                  }`
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Tweet about an article that helped you
                </p>
              </div>
              <div className="text-center p-6">
                <div className="text-3xl mb-3">💼</div>
                ...
                <p className="text-gray-600 text-sm">
                  The best way to support is working together
                </p>
              </div>
              <div className="text-center p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Tell me what content you'd like to see
                </p>
              </div>
            </div>
          </div>
              ...
              >
                <div className="text-left">
                  ...
                  <div className="text-sm opacity-90">
                    QRIS, Bank Transfer, E-Wallet Indonesia
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/40 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Explore amazing workspace setups and get inspired
              </p>
              <a
                href="/workspace"
            ...
            <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/40 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-400 text-sm mb-4">
                View my latest projects and creative work
              </p>
              <a
                href="#portfolio"
            ...
            <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/40 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Read my thoughts on tech, business, and life
              </p>
              <a
                href="#blog"
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 md:p-12 inline-block">
              ...
              <p className="text-blue-100 text-lg mb-6 max-w-xl">
                Whether you want to explore workspaces, discuss a project, or
                just say hello, I'm here to help you succeed.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/workspace"
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              Even if we don't work together, I'm always happy to chat.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-8">
                  I'm based in Denpasar, Bali, but work with people everywhere.
                  Prefer a quick call? Love a long email? Want to meet for
                  actual coffee? I'm flexible.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      I usually reply within 2 hours
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-12">
              <form
                ...
                onSubmit={(e) => {
                  ...
                  const firstName =
                    (form.firstName as HTMLInputElement)?.value || "";
                  const lastName =
                    (form.lastName as HTMLInputElement)?.value || "";
                  const email = (form.email as HTMLInputElement)?.value || "";
                  const phone = (form.phone as HTMLInputElement)?.value || "";
                  const service =
                    (form.service as HTMLSelectElement)?.value || "";
                  const budget =
                    (form.budget as HTMLSelectElement)?.value || "";
                  const message =
                    (form.message as HTMLTextAreaElement)?.value || "";
                  ...
                  const text =
                    ...
                    `*Budget:* ${budget}\n` +
                    `*Details:* ${message}`;
                  const whatsappUrl = `https://wa.me/62895323496371?text=${encodeURIComponent(
                    text
                  )}`;
