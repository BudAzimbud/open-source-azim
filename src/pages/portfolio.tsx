...
const services = [
  {
    ...
    description:
      "Build powerful web and mobile applications tailored to your business needs",
    image:
  ...
  },
  {
    ...
    description:
      "Create stunning online stores that convert visitors into customers",
    image:
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white space-y-6">
                ...
                <h1 className="text-5xl md:text-7xl font-light leading-tight text-[#F3F4F6]">
                  Hi, I'm{" "}
                  <span className="text-[#FACC15] font-normal">Azim</span>
                  <br />
                  <span className="text-3xl md:text-4xl text-[#F3F4F6]/80">
                ...
                <p className="text-xl md:text-2xl text-[#F3F4F6]/80 leading-relaxed max-w-2xl">
                  ...
                  into simple, beautiful designs. Currently helping businesses
                  grow through thoughtful technology.
                </p>

                <div className="flex flex-col sm:flex-row gap-4 pt-6">
                  <button className="bg-[#FACC15] hover:bg-[#FACC15]/90 text-[#0F0F0F] px-8 py-4 rounded-xl font-medium transition-all duration-300 hover:scale-105 transform text-lg">
                    Let's work together
                  </button>
                  <button className="border border-[#F3F4F6]/30 hover:border-[#FACC15] hover:bg-[#FACC15]/10 text-[#F3F4F6] px-8 py-4 rounded-xl font-medium transition-all duration-300 text-lg">
                    See my work
                  </button>
                </div>
              </div>
